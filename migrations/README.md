...
| 2026-09-20 | 20260920-drop-leagues-venue-column.mjs | Drop the old free-text leagues.venue column, run after the venues code was deployed (production shares this DB) |
