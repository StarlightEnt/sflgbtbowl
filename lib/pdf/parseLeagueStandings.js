...
// One row = every text item sharing the same y-coordinate on one page,
// left-to-right. Both real fixtures print each visual line's items at
// an identical y (confirmed by direct coordinate inspection), so no
// clustering/tolerance is needed — an exact match is reliable.
