...
export function canViewContactInfo({ isAdmin, isOfficer, isOwnCard, viewerMembership, targetMembership }) {
  if (isOwnCard) return true;
  // Officers get the same full bypass as admins — a deliberate,
  // explicit expansion of the tiered rule below, not an accidental
  // widening.
