...
export const { handlers, auth, signIn, signOut } = NextAuth(() => {
  ...
  return {
    ...
    providers: [
      Google,
      Resend({
        // TODO: switch to officers@sflgbtbowl.com once that domain is
        // verified in Resend — onboarding@resend.dev is their sandbox
        // sender and works without any DNS setup.
